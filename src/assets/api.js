...
e.prototype.attachEvent=function(a,b){this.isConnected?(this.events[a]=b,this.sendMessage({type:"attachEvent",name:a})):console.log("Connector is not connected with editor")};e.prototype.detachEvent=function(a){this.events[a]&&(delete this.events[a],this.isConnected?this.sendMessage({type:"detachEvent",name:a}):console.log("Connector is not connected with editor"))};e.prototype._correctCustomMenuItems=function(a,b){var c={guid:this.guid};b.tabs?c.tabs=[]:c.items=[];let d=function(p,h){let k={id:void 0!==
h.id?h.id:n()};for(prop in h)switch(prop){case "id":case "items":case "onClick":break;case "url":case "icons":k[prop]=(new URL(h[prop],location.href)).href;break;default:k[prop]=h[prop]}if(h.items){k.items=[];for(var q=0,r=h.items.length;q<r;q++)k.items.push(d(p,h.items[q]))}else h.onClick&&(p[a][k.id]=!0,p.attachEvent(k.id,h.onClick));return k};if(b.tabs){c.tabs=[];for(var f=0,l=b.tabs.length;f<l;f++)c.tabs.push(d(this,b.tabs[f]))}else for(c.items=[],f=0,l=b.length;f<l;f++)c.items.push(d(this,b[f]));
return c};e.prototype._addCustomMenuEvent=function(a){let b="";"contextMenuEvents"==a?b="onContextMenuClick":"toolbarMenuEvents"==a&&(b="onToolbarMenuClick");this.events[b]||this.attachEvent(b,function(d){var f=void 0,l=d.indexOf("_oo_sep_");-1!==l&&(f=d.substring(l+8),d=d.substring(0,l));this.events[d]&&this.events[d].call(this,f)}.bind(this));if(this[a])for(var c in this[a])this[a].hasOwnProperty(c)&&this.detachEvent(c);this[a]={}};e.prototype.addContextMenuItem=function(a){this._addCustomMenuEvent("contextMenuEvents");
this.executeMethod("AddContextMenuItem",[this._correctCustomMenuItems("contextMenuEvents",a)])};e.prototype.updateContextMenuItem=function(a){this.executeMethod("UpdateContextMenuItem",[this._correctCustomMenuItems("contextMenuEvents",a)])};e.prototype.addToolbarMenuItem=function(a){this._addCustomMenuEvent("toolbarMenuEvents");this.executeMethod("AddToolbarMenuItem",[this._correctCustomMenuItems("toolbarMenuEvents",a)])};g.prototype._register=function(){this.connector._windows||(this.connector._windows=
{});this.connector._windows[this.id]=this};g.prototype._unregister=function(){this.connector._windows&&this.connector._windows[this.id]&&delete this.connector._windows[this.id]};g.prototype.show=function(a){var b=(new URL(a.url,location.href)).href;b=-1===b.indexOf(".html?")?b+"?windowID=":b+"&windowID=";b+=this.id+"&guid="+encodeURIComponent(this.connector.guid);a.url=b;a.icons&&(a.icons=(new URL(a.icons,location.href)).href);this._register();this.connector.executeMethod("ShowWindow",[this.id,a])};
g.prototype.activate=function(){this.connector.executeMethod("ActivateWindow",[this.id])};g.prototype.close=function(){this._oncommand("onClose");this.connector.executeMethod("CloseWindow",[this.id]);this._unregister()};g.prototype.dispatchEvent=function(a,b){this.connector.executeMethod("SendToWindow",[this.id,a,"object"===typeof b?JSON.stringify(b):b])};g.prototype.attachEvent=function(a,b){this._events[a]=b};g.prototype.detachEvent=function(a){this._events&&this._events[a]&&delete this._events[a]};
g.prototype._oncommand=function(a,b){this._events&&this._events[a]&&this._events[a].call(this,b)};e.prototype.createWindow=function(){return new g(this)};m.Asc=m.Asc?m.Asc:{};m.Asc.EditorConnector=e})(window);
    ...
    function extendAppPath(config,  path) {
        if ( !config.isLocalFile ) {
            const ver = '/8.3.3-c5bbd5b568d95d459107c28cff3b3dee';
